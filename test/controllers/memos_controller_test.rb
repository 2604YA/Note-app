...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { class: @memo.class, definition: @memo.definition, description: @memo.description, example: @memo.example, word: @memo.word } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { class: @memo.class, definition: @memo.definition, description: @memo.description, example: @memo.example, word: @memo.word } }
